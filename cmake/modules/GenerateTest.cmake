...
function(generate_test TESTNAME)
    ...
    if (DEFINED ARG_QML_TEST)
        ...
        if (${ARG_USE_DBUS})
            ...
            set(TEST_COMMAND gdb -p -x -p /tmp/gdbcomm -p --args -p ${CMAKE_CURRENT_BINARY_DIR}/${TESTNAME} ${PLATFORM} -p -o -p -,txt -p -o -p ${CMAKE_BINARY_DIR}/test_${TESTNAME}.xml,xunitxml)
