...
NewAccountInterface {
    ...
    advancedParams: [
        {'name': 'discover-stun', 'inputType': 'boolean', 'label': i18n.tr('Discover the STUN server automatically'), 'store': true},
        ...
        {'name': 'discover-binding', 'inputType': 'boolean', 'label': i18n.tr('Divscover Binding'), 'store': true},
        {'name': 'prosy-host', 'inputType': 'string', 'label': i18n.tr('Proxy server'), 'store': true},
        {'name': 'port', 'inputType': 'numeric', 'label': i18n.tr('Proxy port'), 'store': true},
        {'name': 'keepalive-mechanism', 'inputType': 'string', 'label': i18n.tr('Keep alive mechanism'), 'store': true},
        ...
        {'name': 'transport', 'inputType': 'string', 'label': i18n.tr('Transport'), 'store': true},
        {'name': 'loose-routing', 'inputType': 'boolean', 'label': i18n.tr('Loose Routing'), 'store': true},
    ]
}
